export declare type FetcherContextType = {
    headers?: any;
    baseUrl?: string;
    /**
...
export declare type RequestWithBody = <R = any, BodyType = any>(
/**
 * The request url
 */
url: string, 
 ...
 */
export declare type ImperativeFetcher = {
    get: RequestWithBody;
...
export declare type FetcherConfigTypeNoUrl<FetchDataType = any, BodyType = any> = Omit<FetcherConfigType<FetchDataType, BodyType>, "url">;
/**
