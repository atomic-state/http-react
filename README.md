...
```html
<script src="https://unpkg.com/http-react-fetcher@2.2.7/dist/http-react-fetcher.min.js"></script>
```
...
```html
<script src="https://unpkg.com/http-react-fetcher@2.2.7/dist/vanilla.min.js"></script>
```
