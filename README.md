...
```html
<script src="https://unpkg.com/http-react-fetcher@1.9.5/dist/http-react-fetcher.min.js"></script>
```
...
```html
<script src="https://unpkg.com/http-react-fetcher@1.9.5/dist/vanilla.min.js"></script>
```
