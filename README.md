...
```html
<script src="https://unpkg.com/http-react-fetcher@1.5.7/dist/http-react-fetcher.min.js"></script>
```
Without React

```html
<script src="https://unpkg.com/http-react-fetcher@1.5.7/dist/vanilla.min.js"></script>
```
