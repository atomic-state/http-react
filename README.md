...
```html
<script src="https://unpkg.com/http-react-fetcher@1.5.1/dist/http-react-fetcher.min.js"></script>
```
Without React

```html
<script src="https://unpkg.com/http-react-fetcher@1.5.1/dist/vanilla.min.js"></script>
```
