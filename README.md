...
```html
<script src="https://unpkg.com/http-react-fetcher@2.2.1/dist/http-react-fetcher.min.js"></script>
```
...
```html
<script src="https://unpkg.com/http-react-fetcher@2.2.1/dist/vanilla.min.js"></script>
```
